...
/**
 * Servlet implementation class S2A2GetServlet
 */
@WebServlet("/S2A2GetServlet")
public class S2A2GetServlet extends HttpServlet {
	public int count = 0;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		important = (String) session.getAttribute("Important");
		...
		out.println("<h3>出力画面：もう一度</h3>");
		out.println("重要度：" + important);
		out.println("<p>内容：" + text);
		out.println("<br>");
		out.println("<br>");
